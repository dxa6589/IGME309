...
void Application::Display(void)
{
	...
	//quaternion q4 = quaternion(glm::radians(m_v3Rotation));

	// SOLUTION
	m_qOrientation *= glm::angleAxis(glm::radians(m_v3Rotation.x), AXIS_X);
	m_qOrientation *= glm::angleAxis(glm::radians(m_v3Rotation.y), AXIS_Y);
	m_qOrientation *= glm::angleAxis(glm::radians(m_v3Rotation.z), AXIS_Z);
